                  ...
                  <div className="options">
                    <div className="optionItem">
                      ...
                      <div className="optionCounter">
                        <button
                          ...
                          onClick={() => dispatch(optionsDicress("adult"))}
                        >
                          -
                        </button>
                        ...
                        <button
                          className="optionCounterButton"
                          onClick={() => dispatch(optionsIngreass("adult"))}
                        >
                          +
                        </button>
                      </div>
                    ...
                    <div className="optionItem">
                      ...
                      <div className="optionCounter">
                        ...
                        <button
                          className="optionCounterButton"
                          onClick={() => dispatch(optionsIngreass("children"))}
                        >
                          +
                        </button>
                      </div>
                    ...
                    <div className="optionItem">
                      ...
                      <div className="optionCounter">
                        <button
                          ...
                          className="optionCounterButton"
                          onClick={() => dispatch(optionsDicress("room"))}
                        >
                          -
                        </button>
                        <span className="optionCounterNumber">
                        ...
                        <button
                          className="optionCounterButton"
                          onClick={() => dispatch(optionsIngreass("room"))}
                        >
                          +
                        </button>
                      </div>
